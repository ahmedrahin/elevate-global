...
<html lang="en">
  <head>
    ...
    <title>Managed IT Services || Elevate Global Group Pty</title>
    <!-- Fav Icon -->
  ...
  <body>
    ...
    <!-- pages-banner start -->
    <section class="pages-banner service managed">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <p>
                        Managed IT Services
                        Our team of experts will manage your entire IT infrastructure, <br> from network maintenance to security updates. </p>
                    <button class="btn-started" type="button" data-bs-toggle="modal" data-bs-target="#started">                    
                        INQUIRE ABOUT MANAGED OPERATIONS
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    ...
                    <h1>Streamline Your Operations with Our Managed IT Solutions</h1>
                    <p>Elevate Global Group's Managed IT Services go beyond conventional support. We understand that your IT infrastructure is the backbone of your business, and its seamless operation is critical to your success. Our comprehensive approach ensures that your systems are not only maintained but optimized for peak performance.</p>
                    <p>Build a solid foundation for your business with our IT infrastructure design and implementation services. We'll design, deploy, and manage your infrastructure, tailored to your unique needs.</p>
                </div>
                <div class="col-lg-5 col-md-5">
                    <img src="images/bg2.png.jpg" alt="" class="service-img" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="150" data-aos-once="true">
                </div>
            ...
            <div class="row sec-row">
                <div class="col-lg-5 col-md-5">
                    <img src="images/c2.png" alt="" class="service-img" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="150" data-aos-once="true">
                </div>
                <div class="col-lg-7 col-md-7">
                    <p>With Elevate Global Group's Managed IT Services, you can focus on your core business activities, knowing that your IT infrastructure is in capable hands. The peace of mind you gain allows you to drive your business forward without the worry of technical disruptions.</p>
                    <ul>
                        <li>
