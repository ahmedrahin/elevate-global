...
<html lang="en">
  <head>
    ...
    <title>Cloud Services || Elevate Global Group Pty</title>
    <!-- Fav Icon -->
  ...
  <body>
    ...
    <!-- pages-banner start -->
    <section class="pages-banner service cloud">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <p>
                        Migrate your data and applications to the cloud for <br> increased flexibility, scalability, and cost savings.  
                    </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-md-7">
                    ...
                    <h1>Elevate Your Business to the Cloud</h1>
                    <p> We empower your business to soar to new heights in the digital realm. Cloud computing has revolutionized the way organizations operate, offering increased flexibility, scalability, and significant cost savings. Our cloud solutions are tailored to seamlessly migrate your data and applications to the cloud, providing you the freedom to work from anywhere while maintaining the highest standards of data security.</p>
                    <h5>Key Benefits of Our Cloud Services:</h5>
                ...
                <div class="col-lg-5 col-md-5">
                    <img src="images/c.jpg" alt="" class="service-img" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="150" data-aos-once="true">
                </div>
