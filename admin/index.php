										...
										<form class="row g-4" action="" method="POST">
											...
											<?php
												...
												if(isset($_POST['login'])){
													...
													$sql    = "SELECT * FROM all_user WHERE email = '$email' AND role = 1 AND status = 1 ";
													...
													if( $row == 1 ){
														...
														while($user_row = mysqli_fetch_array($login)){
															...
															if(  $_SESSION['email'] == $email && $userPassword == $password ){
																header("Location: user.php");
															}
															else if( $_SESSION['email'] != $email || $userPassword != $password ){
